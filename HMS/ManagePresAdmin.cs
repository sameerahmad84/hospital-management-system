...
namespace HMS
{
    public partial class ManagePresAdmin : Form
    {
        public ManagePresAdmin()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Prescriptions", connetionString);
        ...
        private void ManagePresAdmin_Load(object sender, EventArgs e)
        {
